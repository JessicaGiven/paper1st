...
for videonum = 1:videoNUM
    ...
    options.infolder = 'F:\git\paper1st\SalBenchmark-master\Data\DataSet3\ImgsFOGR\';%fullfile( foldername, 'data', 'input',videofolder );
   ...
   %% generating final saliency 
    for index = 1:nframe-1
        ...
        imwrite(Energy, ['F:\git\paper1st\SalBenchmark-master\Data\DataSet3\Saliency\' frameName '_FOGR' '.png']);
    end
