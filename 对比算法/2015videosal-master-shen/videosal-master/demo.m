...
%addpath( genpath( '.' ) );
addpath('C:\master\论文1\daima\对比算法\5.12\2015videosal-master-shen\videosal-master');
%foldername = fileparts( mfilename( 'fullpath' ) );
%foldername = fileparts( 'C:\master\论文1\daima\对比算法\5.12\2015videosal-master-shen\videosal-master');
foldername = fileparts( mfilename( 'C:\master\论文1\daima\对比算法\5.12\2015videosal-master-shen\videosal-master' ) );
...
%videoFiles = dir('C:\master\论文1\daima\对比算法\5.12\2015videosal-master-shen\videosal-master\data\input\boat.bmp');
videoFiles = dir(fullfile('C:\master\论文1\daima\对比算法\5.12\2015videosal-master-shen\videosal-master\data\input\boat', 'data', 'input'));
