...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
[filename, pathname]=uigetfile({'0000000001.png','C:\master\dataset\SegTrackv2\SegTrackv2\JPEGImages\frog'});
...
[sfilename,sfilepath]=uiputfile({'C:\master\dataset','untitled.jpg'});
